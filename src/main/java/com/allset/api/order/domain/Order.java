...
public class Order extends PostgresEntity {
    ...
    /**
     * Express — fase de propostas: NOW() + 10min (profissionais respondem).
     * Express — fase de escolha: NOW() + 30min a partir da primeira proposta.
    ...
    @Builder.Default
    private BigDecimal searchRadiusKm = BigDecimal.valueOf(15);
